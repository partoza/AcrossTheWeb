...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-black dark:text-white antialiased font-sans flex flex-col">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white dark:bg-[#161616] p-6 rounded-[14px] border border-black/5 dark:border-white/5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:border-black/20 dark:hover:border-white/20 transition-colors flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-gray-50 dark:bg-[#111111] flex items-center justify-center text-[18px] font-bold text-gray-900 dark:text-white mb-4 border border-black/5 dark:border-white/5 overflow-hidden">
                  {member.image ? (
      ...
      <section id="services-preview" className="py-32 px-6 sm:px-8 md:px-12 bg-gray-50 dark:bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-[11px] font-semibold tracking-wider uppercase mb-6 block text-gray-500 dark:text-gray-400">Sneak Peek</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl leading-tight font-semibold tracking-tighter text-black dark:text-white mb-6">
              Our Core Services
            </h2>
            <p className="text-lg text-gray-500 dark:text-[#888] font-normal leading-relaxed mb-8">
              A quick look at how we can help you grow. From web development to executive VA support.
            </p>
            <a href="/services" className="inline-block bg-black dark:bg-white text-white dark:text-black px-8 py-3.5 rounded-full text-[15px] font-medium hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-md">
              View Full Catalog
            </a>
          </div>
            ...
            {[
              {
                ...
                desc: "Custom, responsive websites engineered to convert.",
                image: "/services/webdevelopment.png"
              },
              {
                title: "Video Editing & Reels",
                desc: "Engaging social media Reels and YouTube edits.",
                image: "/services/videoediting.png"
              },
              {
                title: "Graphic Design & Branding",
                desc: "Stunning logos, pitch decks, and brand books.",
                image: "/services/graphicdesign.png"
              }
            ].map((service, i) => (
              <div key={i} className="spotlight-card group relative bg-white dark:bg-[#000] rounded-xl border border-gray-200 dark:border-[#333] hover:border-gray-300 dark:hover:border-[#555] transition-all duration-300 overflow-hidden flex flex-col shadow-sm">
                <div className="w-full h-40 overflow-hidden border-b border-gray-200 dark:border-[#333]">
                  <img src={service.image} alt={service.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-6">
                  <h3 className="text-[18px] font-semibold text-black dark:text-white mb-2">{service.title}</h3>
                  <p className="text-[14px] text-gray-500 dark:text-[#888]">{service.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Footer */}
      <footer id="support-contact" className="border-t border-gray-200 dark:border-[#333] bg-white dark:bg-[#000] py-16 px-6 sm:px-8 md:px-12">
        <div className="max-w-7xl mx-auto">

...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-white dark:bg-[#050505] border-t border-gray-100 dark:border-[#111] py-20 px-6 md:px-12 xl:px-24">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 xl:gap-24">
        ...
        <div className="flex flex-col">
          <Link href="/" className="flex items-center gap-2.5 mb-8 shrink-0">
            ...
            />
            <span className="text-black dark:text-white font-bold text-xl tracking-tight font-sans">
              acrosstheweb
            </span>
          </Link>
